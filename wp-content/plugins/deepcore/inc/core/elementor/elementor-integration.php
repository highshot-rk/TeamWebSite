    ...
    final class Webnus_Elementor_Extentions {
        ...
        public function init() {
            ...
            add_action( 'elementor/frontend/after_register_scripts', function() {
                ...
                wp_register_script( 'wn-news-ticker',           DEEP_ASSETS_URL . 'js/libraries/jquery.ticker.js',              [ 'jquery' ], DEEP_VERSION, true );
        ...
        */
        public function deep_widget_styles() {
            ...
            wp_register_style( 'wn-deep-blog', DEEP_ASSETS_URL . 'css/frontend/base/deep-blog.css' );

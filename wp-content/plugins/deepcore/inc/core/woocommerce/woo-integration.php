            ...
            <div class="wn-woo-list-thubmnail">
                ...
                <?php if ( is_plugin_active( 'yith-woocommerce-quick-view/init.php' ) ) : ?>
                    <div class="wn-woo-btn wn-quick-view-btn" data-wntooltip="<?php esc_html_e( 'Quick View', 'deep' ); ?>">
                        <?php YITH_WCQV_Frontend::get_instance()->yith_add_quick_view_button(); ?>
...
// Compare
if ( ! function_exists( 'deep_woo_yith_woocompare_popup_head' ) ) :
    function deep_woo_yith_woocompare_popup_head() {

        wp_enqueue_style( 'deep_yith_woocompare', DEEP_URL . '/inc/core/woocommerce/assets/woocommerce.css', DEEP_VERSION, true );
        wp_enqueue_style( 'deep_yith_iconfonts', DEEP_ASSETS_URL . 'css/frontend/base/07-iconfonts.css', DEEP_VERSION, true );
        wp_enqueue_style( 'deep_yith_google_fonts', deep_google_fonts_url() , DEEP_VERSION, true );

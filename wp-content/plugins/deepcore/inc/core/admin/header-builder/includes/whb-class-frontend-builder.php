    ...
    class WHB_Frontend_Builder {
		...
		public function admin_enqueue_scripts() {
			...
			$color_picker_strings = array(
				'clear'            => __( 'Clear', 'deep' ),
				'clearAriaLabel'   => __( 'Clear color', 'deep' ),
				'defaultString'    => __( 'Default', 'deep' ),
				'defaultAriaLabel' => __( 'Select default color', 'deep' ),
				'pick'             => __( 'Select Color', 'deep' ),
				'defaultLabel'     => __( 'Color value', 'deep' ),
			);

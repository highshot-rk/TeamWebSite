...
function deep_admin_enqueue() {
	...
	if ( function_exists( 'kc_add_icon' ) ) {
		...
		wp_enqueue_style( 'deep-iconfonts-style', DEEP_ASSETS_URL . 'css/frontend/base/07-iconfonts.css', null, null );
	}
...
function deep_is_blog() {
    return ( is_author() || is_category() || is_tag() || is_date() || is_home() || is_archive() || is_singular( 'post' ) );
}

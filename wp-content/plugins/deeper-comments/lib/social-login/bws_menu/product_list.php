...
$bws_plugins = array(
	...
	'depc-social-login-bws/depc-social-login-bws.php' => array(
		'category'		=> array( 'smm' ),
		'name'			=> 'Social Login',
		'description'	=> __( 'Add social media login, registration, and commenting to your WordPress website.', 'bestwebsoft' ),
		'link'			=> 'https://bestwebsoft.com/products/wordpress/plugins/depc-social-login/?k=62817c9c94f24129e40894e1d9c3f49d&pn=' . $bws_plugin_info["id"] . '&v=' . $bws_plugin_info["version"] . '&wp_v=' . $wp_version,
		'settings'		=> 'admin.php?page=depc-social-login.php'
	),
